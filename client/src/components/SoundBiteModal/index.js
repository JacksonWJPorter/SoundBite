...
import { Button, TextField, Paper, Typography, Box, Grid, Card, CardActions, CardContent } from '@material-ui/core';
    ...
    >
      <Box className={classes.cardHeader}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'row-reverse', alignContent: 'space-around', height: "100%", width: "50%"}}>
          ...
          <Button className={classes.buttons} variant="contained">Download as Word</Button>
          <Button className={classes.buttons} variant="contained">Download as PDF</Button>
        </Box>
      </Box>
