...
function GetTeamSoundBites(props){
 ...
 console.log(data + "This is the data Mateo")
   return (
...
<>
  ...
  <Modal open={open} handleClose={handleClose}>
    <div style={{ backgroundColor: "white", width: "80%", margin: "auto", padding: "20px" }}>
      <h2>My SoundBites</h2>
      <p>
        Please Select the Soundbite you would like to share
      </p>
      <MySoundBitesModal teamID ={props.teamID} handleClose={handleClose}/>
